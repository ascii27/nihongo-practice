...
- Every review row counts toward the target regardless of origin — mixed practice and lesson blocks both `POST /api/reviews`. Cram does not log reviews and must stay outside the budget.
